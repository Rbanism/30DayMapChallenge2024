...
p <- ggplot() +
  ...
  geom_point(data = geo_data, aes(x = long, y = lat, size = count*4), 
             color = "yellow", alpha = 0.1,
             show.legend = TRUE) + # Outer glow with size based on count
  geom_point(data = geo_data, aes(x = long, y = lat, size = count*2), 
             color = "yellow", alpha = 0.1,
             show.legend = TRUE) + # Middle glow with size based on count
  geom_point(data = geo_data, aes(x = long, y = lat, size = count*1.5), 
  ...
  scale_size_continuous(
    ...
    range = c(3, 10)) + # Adjust size range if necessary
...
p <- p +
   # Control legend appearance
    labs(
    title = "Events organized by squats in European cities",
    # subtitle = "number",
    legend.title = "Event Density", # Custom legend title
